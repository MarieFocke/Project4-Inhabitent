...
function red_starter_scripts() {
	...
	wp_enqueue_style('red_starter_style', get_stylesheet_uri());

	wp_enqueue_script( 'red-starter-search', get_template_directory_uri() . '/build/js/search.min.js', array(), '20151215', true );
